...
//         }
//         leadGuidance = new LeadPlay(guidance, user, readFileRowCount, leadFile.modelPositions, materialArray, availableNum);
...
//     public LeadPlay(GameObject guidance, GameObject user, int fileRowCount, Vector3[] positions, Material[] materialArray, int availableNum)
